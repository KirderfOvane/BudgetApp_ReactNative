...
const GuideModal = () => {
  ...
  return (
    <>
      <View className='guide__modal' style={{ zIndex: guide === '17' ? 33 : 1 }}></View>
      <View>
        {guide === '1' && (
          <View className='guide__card'>
            <Text className='guide__title'>Budget App Guide</Text>
            <Text className='guide__title__h3'>Welcome {isAuthenticated && user.name}!</Text>
            <Text>To be able to properly use this App we suggest following this quick guided tour of all the features.</Text>
